...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_9th44nc', 'template_hytnk1l', form.current, 'qkqyhPqJdkUK7-Q_-')
      .then((result) => {
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        <motion.div className='flex-1'
          ...
          <h2 className='leading-none text-[45px] lg:text-[90px] mb-12'>lets work <br/>together</h2>
        </motion.div>
